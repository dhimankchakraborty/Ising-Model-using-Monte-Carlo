...
concentration_array = [1, 0.8, 0.6, 0.4]
...
for j, concentration in enumerate(concentration_array):
    ...
    for i, temp in enumerate(temp_array):
        ...
        energy_v_temp_arr[j, i] = av_energy_per_spin_arr.mean()
        magnetization_v_temp_arr[j, i] = av_magnetization_per_spin_arr.mean()
        susceptibility_v_temp_arr[j, i] = av_susceptibility_per_spin_arr.mean()
